...
- **The `.tasks/` board is the live status.** `docs/PLAN.md` defines the plan; the board
  ...
  there. Current milestone: **`#mcp2`**, the stable line (currently 1.1.1) and remaining qualification.
...
in flight. Current milestone: **#mcp2**, with the current 1.1.1 release and remaining integrated

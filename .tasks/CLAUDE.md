...
|---|---|---|
| shaughv-health-mcp (this repo) | 1.0.0 stable release live; qualification active | Source of truth: `docs/PLAN.md`; audience = ADR-0002; hosting/runtime = ADR-0003; remaining qualification/soak = `#mcp2`/`#q2`. The 0.3.0 cutover receipts remain historical; the webhook physical gate remains separate under `#w11` |

...
|---|---|---|
| shaughv-health-mcp (this repo) | 1.0.0 stable release in progress | Source of truth: `docs/PLAN.md`; audience = ADR-0002; hosting/runtime = ADR-0003; release qualification/soak = `#mcp2`/`#q2`. The 0.3.0 cutover receipts remain historical; the webhook physical gate remains separate under `#w11` |
